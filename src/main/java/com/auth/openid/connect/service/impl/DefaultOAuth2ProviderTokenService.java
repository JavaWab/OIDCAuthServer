...
import com.auth.openid.connect.token.keypair.OIDCKeyPairGenerator;
import com.auth.openid.connect.token.model.AuthenticationHolderEntity;
import com.auth.openid.connect.token.model.PKCEAlgorithm;
import com.auth.utils.IdTokenHashUtils;
